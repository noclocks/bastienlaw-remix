...
import "../styles/other-practice-areas.css"
                  ...
                  <div className='et_pb_row et_pb_row_2_tb_body'>
                    <div className='et_pb_column et_pb_column_2_3 et_pb_column_2_tb_body fl-main-content  et_pb_css_mix_blend_mode_passthrough'>
                      <div className='et_pb_module et_pb_post_content et_pb_post_content_0_tb_body'>
                        <h1>How My Firm Can Support Your Other Legal Needs</h1>
                        <p>
                          Every time a person walks through my door at the{' '}
                          <span className='nap-item nap-item--name'>
                            Law Offices of Villard Bastien, LLC
                          </span>
                          , with a legal problem, there is a different set of
                          challenges and struggles to address. You are not like
                          anyone else, and you deserve to work with an attorney
                          who understands that. Moreover, you deserve to work
                          with an attorney who has prepared for a wide variety
                          of potential issues.
                        </p>
                        <p>
                          I serve clients across Georgia and am licensed to
                          practice in New York and New Jersey. You can call me
                          directly by dialing{' '}
                          <span className='nap-item nap-item--phone'>
                            <a href='tel:+1-404-378-4344'>404-378-4344</a>
                          </span>{' '}
                          or you can <a href='contact'>reach me online</a> to
                          talk about your experiences and get solutions that
                          work for you.
                        </p>
                        <h2>Supporting You When The Unexpected Happens</h2>
                        <p>
                          My extensive legal history and decades working with
                          clients prepare me for almost any issue you may have
                        ...
                        <ul>
                          <li>
                            <a href='serious-injury'>Slip-and-fall accidents</a>
                          </li>
                          <li>
                            <a href='serious-injury'>Wrongful death claims</a>
                          </li>
                          <li>
                            <a href='serious-injury'>
                              Medical malpractice suits
                            </a>
                          </li>
                          <li>
                            <a href='criminal-law-defense'>Criminal defense</a>
                          </li>
                        </ul>
                        <p>
                          You’ll find a kind ear at the{' '}
                          <span className='nap-item nap-item--name'>
                            Law Offices of Villard Bastien, LLC
                          </span>
                          , to guide you through whatever legal steps are needed
                          to protect you and your loved ones.
                        </p>
                        <h2>You Can Trust Me To Be Your Strongest Defender</h2>
                        <p>
                          I am a seasoned advocate who has been through this
                          before. I will tailor a strategic case that will give
                          you the best opportunity for success. These can
                          include timely filings, challenging evidence,
                          scrutinizing procedures or fighting illegal searches.
                          I listen with compassion - then propose a
