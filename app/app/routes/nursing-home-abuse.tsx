                  ...
                  <div className="et_pb_row et_pb_row_2_tb_body">
                    <div className="et_pb_column et_pb_column_2_3 et_pb_column_2_tb_body fl-main-content  et_pb_css_mix_blend_mode_passthrough">
                      <div className="et_pb_module et_pb_post_content et_pb_post_content_0_tb_body">
                        ...
                        <p>
                          As older loved ones need more and more care, most
                          people must make a difficult decision: How do you
                          adequately care for your loved one&rsquo;s increasing
                          needs while still providing for yourself and living
                          your life? For many, the answer is placing your older
                          family members in the care of a nursing facility.
                        </p>
                        <p>
                          Unfortunately, sometimes those facilities do not
                          follow standards of care, and our elderly loved ones
                        ...
                        <h2>
                          Are You Concerned About The Quality Of Care Your Loved
                          One Is Getting?
                        </h2>
                        <p>
                          Unfortunately, even the most well-intentioned nursing
                          facility is often over-burdened and understaffed. This
                          often results in medical errors and opportunities for
                          abuse. Experiencing concern is normal. You should call
                          an attorney if you see consistent patterns of abuse or
                          neglect, including:
                        </p>
                        <ul>
                          <li>Recurrent bed sores or ulcers</li>
                          <li>
                            Unaddressed issues with medication, including
                            misdosing of medications and unnecessary treatment
                          </li>
                          <li>Unexplained bruising or injuries</li>
                          <li>
                            Missing valuables or discrepancies with bills and
                            bank accounts
                          </li>
                          <li>
                            Behavioral changes, especially in response to a
                            particular person
                          </li>
                        </ul>
                        <p>
                        ...
                        <h2>Protect Your Loved One</h2>
                        <p>
                          I understand what both insurance companies and nursing
                          homes will do and say in a lawsuit because I was once
