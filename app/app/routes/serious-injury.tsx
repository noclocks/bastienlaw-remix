                  ...
                  <div className='et_pb_row et_pb_row_2_tb_body'>
                    <div className='et_pb_column et_pb_column_2_3 et_pb_column_2_tb_body fl-main-content et_pb_css_mix_blend_mode_passthrough'>
                      <div className='et_pb_module et_pb_post_content et_pb_post_content_0_tb_body'>
                        ...
                        <p>
                          Mr. Bastien has extensive experience trying,
                          prosecuting, defending and evaluating Injury. He
                          understands that the insurance companies drive the
                          settling and trial process for the insured
                          tortfeasors. He was a former defense Attorney for the
                          insurance companies and an insurance company employee.
                          He understands the way they think, settle cases, trial
                          strategies and what drives. Whatever the serious
                          injury,
                        </p>
                        <ul>
