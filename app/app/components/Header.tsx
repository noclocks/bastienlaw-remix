...
export const Header = () => {
  ...
  const handleMobileMenuToggle = (e: MouseEvent) => {
    ...
    parent.classList.contains('opened')
      ? parent.classList.replace('opened', 'closed')
      : parent.classList.replace('closed', 'opened');
  };
          ...
          >
            <div className='et_pb_column et_pb_column_4_4 et_pb_column_2_tb_header  et_pb_css_mix_blend_mode_passthrough et-last-child et_pb_column--with-menu'>
              <div className='et_pb_module et_pb_menu et_pb_menu_1_tb_header fl-mobile-menu fl-3-column et_pb_section_video_on_hover et_pb_bg_layout_light  et_pb_text_align_left et_dropdown_animation_slide et_pb_menu--without-logo et_pb_menu--style-centered'>
                <div className='et_pb_menu_inner_container clearfix'>
                  <div className='et_pb_menu__wrap'>
                    <div className='et_pb_menu__menu'></div>
                    <div className='et_mobile_nav_menu'>
                      <div
                        className='mobile_nav closed'
                        aria-label='Menu'
                      >
                        <span
                          ...
                          onKeyDown={undefined}
                          // style="color: rgba(0, 0, 0, 0.6); letter-spacing: 0px; font-family: 'Open Sans', Helvetica, Arial, Lucida, sans-serif; font-weight: 500; text-transform: none; font-size: 14px;"
                          style={{
                        ...
                        >
                          <li className='menu-item menu-item--depth-0 et_first_mobile_item'>
                            <a
                              href='/'
                              tabIndex={0}
                              // role='link'
                          ...
                          <li className='menu-item menu-item-has-children menu-item--depth-0'>
                            ...
                            <a
                              href='#?'
                              className='toggle-menu fl-toggle-icon'
                              aria-expanded='false'
                          ...
                          <li className='menu-item menu-item-has-children menu-item--depth-0'>
                            <a
                              href='#?'
                              tabIndex={0}
                              className='da11y-submenu fl-menu-toggle-only toggle-menu'
                              aria-expanded='false'
                              // role='link'
                              data-et-icon='C'
                              aria-label='Submenu'
                            ...
                            <ul className='sub-menu'>
                              ...
                              <li className='menu-item menu-item-has-children menu-item--depth-1'>
                                ...
                                <a
                                  ...
                                  className='toggle-menu fl-toggle-icon'
                                  aria-expanded='false'
                                  aria-label='Other Practice Areas Submenu'
                                  onClick={handleMobileToggle}
                                >
                                  C
                                </a>
              ...
              <div className='et_pb_module et_pb_text et_pb_text_2_tb_header fl-3-column et_pb_section_video_on_hover  et_pb_text_align_center et_pb_bg_layout_light'>
                <div className='et_pb_text_inner'>
                  ...
                  <span className='nap-item nap-item--phone'>
                    <a href='tel:+1-404-378-4344'>Call</a>
                  </span>
                </div>
              </div>
